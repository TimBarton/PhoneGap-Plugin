...
- (void)sessionDidConnect:(OTSession*)session{
    ...
    for(id key in session.streams){
        ...
        [streamInfo setObject:aStream.name forKey:@"name"];
        
        [streamInfo setObject:[NSNumber numberWithBool:aStream.hasAudio] forKey:@"hasAudio "];

        [streamInfo setObject:[NSNumber numberWithBool:aStream.hasVideo] forKey:@"hasVideo "];
